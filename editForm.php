...
@media screen and (max-height: 450px) {
  ...
  <div class="overlay-content">
    ...
    <a href="Tables%20.php">Manage Permissions</a><br>
  </div>
</div>
...
?>
      ...
      <form method="post" action="./update_records.php?id=<?$id ?>">

        
          <div class="field">
            <label class="label">Edit User</label>
            <div class="field-body">
              <div class="field">
                <div class="control icons-left"><?php
          if (mysqli_num_rows($result) > 0)
{
  $data = mysqli_fetch_assoc($result) ;
 mysqli_query($conn, $sql);
?>
               <input class="input" id="username" name="username" type="text" value="<?= $data['username']?>">
                  <span class="icon left"><i class="fa-sharp fa-solid fa-user"></i></span>
                </div>
              </div>
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" name="email"  type="email" value="<?php echo $data['email']; ?>">
              ...
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input"id="address" name="address" type="address" value="<?= $data['address']?>"> 
          ...
          <div class="field">
              ...
              <div class="field">
                <div class="field addons">
                  ...
                  <div class="control expanded">
                    <input class="input" type="tel" id="phone_number" name="phone_number" value="<?= $data['phone_number']?>">
                  </div>
                </div>
           ...
           $sql = "INSERT INTO users(username, email, address,phone_number) where id='$id'";
          
            // echo "New record created successfully";
   // echo "harry " . $row["username"].  '9197123 '. $row["Phone_number"]. "user22@example.com ". $row["email"]. "active" .$row["status"]." 7-7-2021". $row["create_at"]."<br>";
  }
